...
<body>
	...
	<div class="card container  mt-4 mb-4 p-4">
		...
		<div class="col-12 mx-auto">
			<form:form action="/books/${id}/update" method="put"
				modelAttribute="editBook" class="p-4 ">
				...
				<div class="form-group">
					...
					<div>
						...
						<form:input type="hidden" path="owner" value="${loggedInUser.id}"
							class="form-control"/>
					</div>
					<div>
						<form:errors path="borrower" class="error"/>
						<form:input type="hidden" path="borrower"
							value="${editBook.borrower.id}" class="form-control"/>
					</div>
